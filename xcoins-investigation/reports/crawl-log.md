...
- 2026-08-27T21:40Z Blockscout MCP connector checked (chains list, query "bitcoin"): EVM-only, no Bitcoin mainnet; Rootstock/Rootstock Testnet are the only Bitcoin-ecosystem entries. Egress retest: mempool.space, blockstream.info, web.archive.org still 403.
